...
<div class="navbar-header">
    ...
    <a class="navbar-brand" href="{{{ URL::to('/')}}}">Panaderia</a>
</div>
<!-- /.navbar-header -->
...
<li class="dropdown">
    ...
    <ul class="dropdown-menu dropdown-user">
        ...
        @endif
        <li class="divider"></li>
        <li><a href="{{{ URL::to('users/logout') }}}"><i class="fa fa-sign-out fa-fw"></i> Cerrar Sesión</a>
        </li>
        @endif
    </ul>
    <!-- /.dropdown-user -->
        ...
        <ul class="nav" id="side-menu">
            ...
            <li>
                ...
                <ul class="nav nav-second-level">
                    ...
                    <li>
                        <a href="morris.html">Adicionar Productos(*.XLS)</a>
                    </li>
                    <li>
                        <a href="morris.html">Actualizar Precios Productos</a>
                    </li>
                </ul>
                <!-- /.nav-second-level -->
            </li>
